...
### Analista de Datos Jr. | Python · SQL · Power BI · DAX

Estudiante de Ingeniería de Sistemas enfocado en **Data Analytics** con experiencia práctica en el ciclo de vida del dato: extracción, limpieza, modelado y visualización. Construyo pipelines de datos y dashboards estratégicos orientados a la toma de decisiones.
...
> Python (Marimo · Pandas) · Power BI · IA Generativa

Pipeline de limpieza sobre dataset CarDekho para análisis de depreciación vehicular. Reducción del tiempo de preprocesamiento en **~40%** con cuadernos Marimo interactivos.

---

### 📊 Dashboard de Rentabilidad y Margen
> Power BI · DAX

Modelo de datos conectando ventas, costos y clientes. Implementación de métricas clave (Utilidad Neta, % Margen Bruto) con reducción del **50%** en tiempo de generación de reportes.

---

### ⚙️ Análisis de Eficiencia en Producción
> Excel Avanzado · Power Query

Automatización de extracción y limpieza de **+5,000 registros** de órdenes. Reducción del **30%** en tiempo de análisis de cuellos de botella.
